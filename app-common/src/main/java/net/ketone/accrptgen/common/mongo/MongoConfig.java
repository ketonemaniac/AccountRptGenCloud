...
import net.ketone.accrptgen.common.credentials.EnableSettings;
...
@Configuration
@EnableSettings
@EnableMongoRepositories(basePackages = {"net.ketone.accrptgen.common.repo"})
@ComponentScan({"net.ketone.accrptgen.common.domain"})
